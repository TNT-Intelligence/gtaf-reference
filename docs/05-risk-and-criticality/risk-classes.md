...
- **RP3 — Autonomy amplifies risk**: higher [delegation level](../10-terminology/glossary.md#delegation-level) requires re‑evaluation.
- **RP4 — Scope‑bound**: risk class is assigned per [scope](../10-terminology/glossary.md#scope), not globally.
...
- a [DRB](../02-artifacts/decision-review-board.md) explicitly approves the downgrade and a new [DRC](../02-artifacts/delegation-readiness-check.md) is issued.

## Practical classification procedure

1. Determine scope and anchor to [SB](../02-artifacts/system-boundary.md).
