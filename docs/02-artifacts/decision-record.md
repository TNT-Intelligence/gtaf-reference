...
- Delegation level determines whether an [RB](../02-artifacts/responsibility-binding.md) is mandatory.
- DR defines **permission to delegate**, not a meeting outcome.

## Key references
- [Delegation](../10-terminology/glossary.md#delegation)
- [Delegation Level](../10-terminology/glossary.md#delegation-level)
- [Authority](../10-terminology/glossary.md#authority-decision-authority)
