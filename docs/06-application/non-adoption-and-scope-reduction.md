# Non-adoption and Scope Reduction
...
If a domain cannot meet requirements, the correct response is **to avoid delegation in that scope** until structure and evidence are restored.
