...
- GTAF answers **decision authority** within explicit [boundaries](../02-artifacts/system-boundary.md) and [scope](../10-terminology/glossary.md#scope).
...
- [Decision Records](../02-artifacts/decision-record.md) define what may be delegated.
- [Responsibility Bindings](../02-artifacts/responsibility-binding.md) keep outcome ownership explicit.
- [DRC](../02-artifacts/delegation-readiness-check.md) provides a binary gate before delegation.
