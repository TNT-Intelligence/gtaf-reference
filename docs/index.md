...
## What GTAF is
- A reference model for **safe [delegation](10-terminology/glossary.md#delegation)** in human, automated, and agentic systems.
- **Artifact‑centric**: decisions, boundaries, responsibility, and readiness are explicit objects with identity, [scope](10-terminology/glossary.md#scope), and [validity windows](10-terminology/glossary.md#validity-window).
- A **binary gate** for delegation: structurally **PERMITTED** or **NOT_PERMITTED** via the [DRC](02-artifacts/delegation-readiness-check.md).
...
- [Emergency Intervention System (EIS)](02-artifacts/emergency-intervention-system.md)
...
## License & Citation
License: CC BY 4.0. Citation guidance: see [Citation & Versioning](00-meta/citation-and-versioning.md).
...
- [Core Model Overview](01-core-model/overview.md)
- [Minimal Application Path](06-application/minimal-application-path.md)
- [Claims & Conformance](01-core-model/claims-and-conformance.md)
