...
## Scope coherence
Artifacts in a context must be within the same [scope](../10-terminology/glossary.md#scope) or explicitly linked by cross‑scope rules. Scope leakage invalidates readiness.
