...
## Reachability
Reachability is a safety property: escalation/intervention must be practically reachable within [time‑to‑harm](../10-terminology/glossary.md#time-to-harm) constraints.
...
See: [Authority & Role Model](../03-rules/authority-and-role-model.md).
